...
for index in range(len(BATCH_SIZE)):
    ...
    train_set = MnistDataset('/media/hhj/localssd/DL_data/mnist/MNIST_Data/train')
    test_set = MnistDataset('/media/hhj/localssd/DL_data/mnist/MNIST_Data/test')
