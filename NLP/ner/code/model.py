...
class BasicEvaluation(nn.Cell):
    def __init__(self):
        ...
        self.onehot = mindspore.ops.OneHot()
        self.depth, self.on_value, self.off_value = 12, Tensor(1.0, mindspore.float32), Tensor(0.0, mindspore.float32)
    ...
    def update(self, *inputs):
        ...
        y_pred = self.onehot(y_pred, self.depth, self.on_value, self.off_value)
        y = inputs[1]
        y = y.reshape(y.shape[0] * y.shape[1])
        y = self.onehot(y, self.depth, self.on_value, self.off_value)
