...
class NaiveBayes:
    ...
    def find_mu_and_sigma(self, X, y):
        ...
        for cls in range(self.n_classes):
            ...
            print('size: ', X_class.shape,'mn ', ms.ops.mean(X_class, axis=0))
            self.mu[cls] = ms.ops.mean(X_class, axis=0)
            print('var ', ms.ops.var(X_class, axis=0))
    ...
    def predict_probability(self, X):
        ...
        print("probabilities: ", probabilities[0:5,:])
        print("ops.argmax(probabilities, dim=1): ", ms.ops.argmax(probabilities, dim=1))
