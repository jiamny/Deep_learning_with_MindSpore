...
from train import ConfigYOLOV3ResNet18, create_yolo_dataset,  YoloWithEval, yolov3_resnet18
from prepare_dataset import data_to_mindrecord_byte_image
...
class cfg_test:
    ...
    image_dir = '/media/hhj/localssd/DL_data/Crop_and_weeds/Global_wheat_detection/test'

if __name__ == '__main__':
    cfg_test = cfg_test()

    ckpt_path = './ckpt/'
    cfg_test.ckpt_path = os.path.join(ckpt_path, "yolov3-40_160.ckpt") #此处文件名需要随实际训练epoch情况修改
    data_path = "/media/hhj/localssd/DL_data/Crop_and_weeds/Global_wheat_detection"

    mindrecord_dir_test = os.path.join('.', 'mindrecord/test')
    ...
    if os.path.exists(mindrecord_dir_test) and os.listdir(mindrecord_dir_test):
        ...
        data_to_mindrecord_byte_image(cfg_test.image_dir, mindrecord_dir_test, prefix, 1, None, 0)
