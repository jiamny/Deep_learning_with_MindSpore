...
parser.add_argument('--checkpoint_path', required=False, type=str,
                    default='./ckpt_files/best.ckpt', help='Checkpoint file path')
parser.add_argument('--image_path', required=False, type=str,
                    default='/media/hhj/localssd/DL_data/mushrooms/test/Russula_fragilis.jpg', help='Image path')
